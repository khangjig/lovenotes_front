...
export function requestGetListNotes(pageData) {
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/note/list`,
            method: 'get',
            params: {
                page: pageData.page,
                size: pageData.size
...
export function requestAddNote(title, content, listImage, date, notifi, pageData) {
    ...
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/note`,
            method: 'post',
            data: formData,
            headers: {
...
export function requestGetInfoNote(id) {
    ...
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/note/getinfo`,
            method: 'get',
            params: {
                id: id
            }
...
export function requestGetNoteImage(id) {
    ...
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/noteimage/list`,
            method: 'get',
            params: {
                noteId: id
            }
...
export function requestGetNoteOnThisDay() {
    ...
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/note/onthisday`,
            method: 'get'
        },
        ).then(res => {
            dispatch({
...
export function requestGetNoteByWeek() {
    ...
    return (dispatch) => {
        ...
        return axios.request({
            url: `https://notelovesserver20191224084100.azurewebsites.net/api/note/byweek`,
            method: 'get'
        },
        ).then(res => {
            dispatch({
